...
const Ranking = ({ isOpen, onClose, fetchPolls }) => {
...
//   };
  ...
  return (
    <div ref={modalRef} className="fixed inset-0 flex justify-center items-center  bg-opacity-50 z-50 p-4">
      <div className="bg-white w-[400px] max-w-lg mx-auto p-6 rounded-lg shadow-lg">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="w-full px-3 py-2 border border-[#202224] rounded-lg text-[#202224] flex items-center">
            ...
            />
            <span className="text-[#202224]">Ranking Polls</span>
            ...
            <div key={option.id} className="flex items-center justify-between space-x-2">
              <div className="flex items-center space-x-2">
                ...
                <div className="flex items-center space-x-1">
                  ...
                  />
                  <label htmlFor={`option-${option.id}-rank-1`}>{option.id}</label>
                </div>
              </div>
