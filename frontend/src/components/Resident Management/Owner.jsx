  ...
  return (
    <div className="flex bg-gray-100 w-full h-full">
      ...
      <div className="flex-1  flex flex-col">
        ...
        <div className=" w-[1500px]  mt-10 ml-[340px]  ">
          <div className="flex ">
            <button
              className={`py-2 px-4 ${
                activeTab === "owner"
          ...
          <form className="space-y-4 bg-white p-3 pt-1"  onSubmit={handleSubmit}>
              ...
              <div className="flex gap-6">
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    className="mt-1 block w-[430px] rounded-md border-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-500"
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="mt-1 block w-[450px] rounded-md border-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-500"
                    placeholder="+91"
                  />
                </div>
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="mt-1 block w-[420px] rounded-md border-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-500"
