          ...
          <div className="  items-center gap-4 mb-8">
            ...
            <div>
              ...
              <p className="text-gray-600 flex  justify-center">
                {!!tenant.Email_address ? tenant.Email_address : "Unknown"}
              </p>
            </div>
          </div>
            ...
            <div className="p-1  ">
              <div className="flex ">
                ...
                <span className=" ml-auto  font-medium">
                  {!!tenant.Wing ? tenant.Wing : "Unknown"}
                </span>
              </div>
              <div className="flex">
                <p className="text-bold  text-black">Unit</p>
                <p className="   ml-auto  font-medium">
                  {!!tenant.Unit ? tenant.Unit : "Unknown"}
                </p>
              </div>
              <div className="flex">
                <p className="text-bold  text-black">Age</p>
                <p className="   ml-auto  font-medium">
                  {!!tenant.Age ? tenant.Age : "Unknown"}
                </p>
              </div>
              <div className="flex">
                <p className="text-bold  text-black">Gender</p>
                <p className="   ml-auto font-medium">
                  {!!tenant.Gender ? tenant.Gender : "Unknown"}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="">
              <div className="flex items-center justify-between p-1  rounded-lg bg-white  shadow-sm">
                <div className="flex items-center gap-3">
                  <div className="rounded-lg bg-blue-50 p-2">
                    <img
                      src={!!tenant.Adhar_front ? tenant.Adhar_front : ""}
                      alt="JPG icon"
                      width={20}
                      height={20}
                    />
                ...
                <a
                  href={!!tenant.Adhar_front ? tenant.Adhar_front : ""}
                  target="_blank"
                  download
              ...
              <div className="flex items-center justify-between p-1 rounded-lg bg-white  shadow-sm">
                <div className="flex items-center gap-2">
                  <div className="rounded-lg bg-red-50 p-2">
                    ...
                    <img
                      src={!!tenant.Adhar_back ? tenant.Adhar_back : ""}
                      alt="JPG icon"
                      width={20}
                      height={20}
                    />
                ...
                <a
                  href={!!tenant.Adhar_back ? tenant.Adhar_back : ""}
                  target="_blank"
                  download
                  className="text-blue-500 hover:text-blue-600"
                >
              ...
              <div className="flex items-center justify-between p-1  rounded-lg bg-white  shadow-sm">
                <div className="flex items-center gap-2">
                  <div className="rounded-lg bg-red-50 p-2">
                    <img
                      src={!!tenant.Address_proof ? tenant.Address_proof : ""}
                      alt="JPG icon"
                      width={20}
                      height={20}
                    />
                ...
                <a
                  href={!!tenant.Address_proof ? tenant.Address_proof : ""}
                  target="_blank"
                  download
                  className="text-blue-500 hover:text-blue-600"
                >
              ...
              <div className="flex items-center justify-between p-1 rounded-lg bg-white  shadow-sm">
                <div className="flex items-center gap-2">
                  <div className="rounded-lg bg-red-50 p-2">
                    <img
                      src={!!tenant.Rent_Agreement ? tenant.Rent_Agreement : ""}
                      alt="JPG icon"
                      width={20}
                      height={20}
                    />
                ...
                <a
                  href={!!tenant.Rent_Agreement ? tenant.Rent_Agreement : ""}
                  target="_blank"
                  download
                  className="text-blue-500 hover:text-blue-600"
                >
