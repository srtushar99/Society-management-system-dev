      ...
      <div className="bg-white shadow-md rounded-md p-3 w-96">
        ...
        <div className="  items-center gap-4 mb-8">
          <img
            ...
            className="w-16 ml-[140px] h-16 rounded-full object-cover"
          />
          <div>
            <h2 className="font-semibold flex  justify-center text-lg text-gray-900">
              {!!owner.Full_name ? owner.Full_name : "Unknown"}
            </h2>

            <p className="text-gray-600 flex  justify-center">
              {!!owner.Email_address ? owner.Email_address : "Unknown"}
            </p>
          </div>
        </div>
        ...
        <div className="mx-2 mt-3">
          ...
          <div className="">
            <div className="flex items-center justify-between  p-1  rounded-lg bg-white  shadow-sm">
              <div className="flex items-center gap-3">
                <div className="rounded-lg bg-blue-50 p-2">
                  <img
                    src={!!owner.Adhar_front ? owner.Adhar_front : ""}
                    alt="JPG icon"
                    width={20}
                    height={20}
                  />
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    {!!Adhar_frontSize ? Adhar_frontSize : ""}
                  </p>
                </div>
              </div>
              <a
                href={!!owner.Adhar_front ? owner.Adhar_front : ""}
                target="_blank"
                download
            ...
            <div className="flex items-center justify-between  p-1  rounded-lg bg-white  shadow-sm">
              <div className="flex items-center gap-2">
                <div className="rounded-lg bg-red-50 p-2">
                  ...
                  <img
                    src={!!owner.Adhar_back ? owner.Adhar_back : ""}
                    alt="JPG icon"
                    width={20}
                    height={20}
                  />
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    {!!Adhar_backSize ? Adhar_backSize : ""}
                  </p>
                </div>
              </div>
              <a
                href={!!owner.Adhar_back ? owner.Adhar_back : ""}
                target="_blank"
                download
                className="text-blue-500 hover:text-blue-600"
              >
            ...
            <div className="flex items-center justify-between  p-1  rounded-lg bg-white  shadow-sm">
              <div className="flex items-center gap-2">
                <div className="rounded-lg bg-red-50 p-2">
                  <img
                    src={!!owner.Address_proof ? owner.Address_proof : ""}
                    alt="JPG icon"
                    width={20}
                    height={20}
                  />
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    {!!Address_proofSize ? Address_proofSize : ""}
                  </p>
                </div>
              </div>
              <a
                href={!!owner.Address_proof ? owner.Address_proof : ""}
                target="_blank"
                download
                className="text-blue-500 hover:text-blue-600"
              >
            ...
            <div className="flex items-center justify-between p-1 rounded-lg bg-white  shadow-sm">
              <div className="flex items-center gap-2">
                <div className="rounded-lg bg-red-50 p-2">
                  <img
                    src={!!owner.Rent_Agreement ? owner.Rent_Agreement : ""}
                    alt="JPG icon"
                    width={20}
                    height={20}
                  />
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    {!!Rent_AgreementSize ? Rent_AgreementSize : ""}
                  </p>
                </div>
              </div>
              <a
                href={!!owner.Rent_Agreement ? owner.Rent_Agreement : ""}
                target="_blank"
                download
                className="text-blue-500 hover:text-blue-600"
              >
        ...
        <div className="mx-2 mt-4 ">
          <div className="flex items-center justify-between  rounded-top  bg-[#5678E9]">
            <h3 className="text-lg font-semibold  ps-2 pt-2">
              Member Counting
            </h3>
            <span className="rounded-full bg-[#5678E9] p-1 pe-3 text-sm text-white">
              {!!owner.Member_Counting_Total ? owner.Member_Counting_Total : 0}
            </span>
          </div>
          <div className=" ">
                ...
                <div className="pt-2">
                  <div className="flex">
                    ...
                    <p
                      ...
                      style={{ fontSize: "12px" }}
                    >
                      {!!member.vehicle_name ? member.vehicle_name : ""}
                    </p>
                  </div>
                  <div className="flex">
                    ...
                    <p
                      ...
                      style={{ fontSize: "12px" }}
                    >
                      {!!member.vehicle_type ? member.vehicle_type : ""}
                    </p>
                  </div>
                  <div className="flex">
                    ...
                    <p
                      ...
                      style={{ fontSize: "12px" }}
                    >
                      {!!member.vehicle_number ? member.vehicle_number : ""}
                    </p>
                  </div>
                </div>
              </div>
