              ...
              <table className="bg-white border border-gray-200 rounded-lg shadow-md lg:w-[1550px]">
                ...
                >
                  <tr className="text-left text-sm font-semibold">
                    ...
                    <th className="ps-3   whitespace-nowrap  sm:table-cell">
                      Phone Number
                    </th>
                    <th className="   text-center whitespace-nowrap sm:table-cell">
                      Select Shift
                    </th>
                    <th className="   text-center whitespace-nowrap lg:table-cell">
                      Shift Date
                    </th>
                    <th className="text-center whitespace-nowrap  lg:table-cell">
                      Shift Time
