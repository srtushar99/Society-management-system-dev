  ...
  <div className="flex gap-6 w-full">
    ...
    <label className="flex items-center border rounded w-[113px] h-[41px] px-[15px] py-[10px] gap-[10px] border-t border-l border-r border-transparent rounded-tl-[10px] opacity-100">
      <input
        ...
        onChange={handleChange}
        className={`w-4 h-4 border-2 ${formData.status === "Open" ? "border-transparent bg-gradient-to-r from-[#FE512E] to-[#F09619]" : "border-[#4CAF50]"}`}
      />
      <span
        className={`ml-2 text-sm ${formData.status === "Open" ? "text-[#202224]" : "text-[#D3D3D3]"}`}
      >
        Open
      </span>
    </label>
    ...
    <label className="flex items-center border rounded w-[113px] h-[41px] px-[15px] py-[10px] gap-[10px] border-t border-l border-r border-transparent rounded-tl-[10px] opacity-100">
      <input
        ...
        onChange={handleChange}
        className={`w-4 h-4 border-2 ${formData.status === "Pending" ? "border-transparent bg-gradient-to-r from-[#FE512E] to-[#F09619]" : "border-[#FFEB3B]"}`}
      />
      <span
        className={`ml-2 text-sm ${formData.status === "Pending" ? "text-[#202224]" : "text-[#D3D3D3]"}`}
      >
        Pending
      </span>
    </label>
    ...
    <label className="flex items-center border rounded w-[113px] h-[41px] px-[15px] py-[10px] gap-[10px] border-t border-l border-r border-transparent rounded-tl-[10px] opacity-100">
      <input
        ...
        onChange={handleChange}
        className={`w-4 h-4 border-2 ${formData.status === "Solve" ? "border-transparent bg-gradient-to-r from-[#FE512E] to-[#F09619]" : "border-[#F44336]"}`}
      />
      <span
        className={`ml-2 text-sm ${formData.status === "Solve" ? "text-[#202224]" : "text-[#D3D3D3]"}`}
      >
        Solve
      </span>
    </label>
