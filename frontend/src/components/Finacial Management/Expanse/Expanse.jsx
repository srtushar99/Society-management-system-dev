...
const initialData = [
  ...
  },
  {
    ...
    description: "Easily compare your planned budget against your expenses...",
    date: "12/02/2024",
    Amount: "1000",
    billFormat: "JPG",
  },
  {
    ...
    description:
      "Identify your largest expenditures, enabling you to adjust accordingly...",
    date: "13/02/2024",
    Amount: "1000",
    billFormat: "PDF",
  },
  {
    ...
    description: "Tailor the dashboard to your unique financial goals...",
    date: "14/02/2024",
    Amount: "1000",
    billFormat: "JPG",
  },
  {
    ...
    description: "Organizing and categorizing your expenses...",
    date: "15/02/2024",
    Amount: "1000",
    billFormat: "PDF",
  },
  {
    ...
    description: "Future-proof your budget by adjusting accordingly...",
    date: "16/02/2024",
    Amount: "1000",
    billFormat: "JPG",
  },
  {
    id: 8,
    title: "Rent or Mortgage",
    description: "Expenses that make sense for your budget...",
    date: "17/02/2024",
    Amount: "1000",
    billFormat: "PDF",
  },
  ...
  },
  {
    ...
    title: "Entertainment",
    description:
      "Simply navigate through the different sections to get a better view...",
    date: "19/02/2024",
    Amount: "1000",
    billFormat: "PDF",
  },
              ...
              <table className="bg-white border 2xl:w-[1560px] border-gray-200 rounded-lg shadow-md w-full">
                ...
                >
                  <tr className="text-left text-sm font-semibold">
                    ...
                    <th className="p-3 text-left whitespace-nowrap  sm:table-cell">
                      Description
                    </th>
                    ...
                    <th className="p-3 ps-5 whitespace-nowrap  lg:table-cell">
                      Bill Format
                    </th>
                ...
                <tbody>
                  {Expense.map((item, index) => (
                    <tr key={index} className="border-t border-gray-200">
                      <td className="p-3  text-start whitespace-nowrap text-gray-700 font-medium">
                        {!!item.Title ? item.Title : ""}
                      </td>
                      <td className="p-3  text-left whitespace-nowrap sm:table-cell text-gray-600">
                        {" "}
                        <span className="break-words w-[800px] whitespace-normal">
                          {!!item.Description ? item.Description : ""}
                        </span>
                      </td>
                      <td className="p-3  text-center md:table-cell text-gray-600">
                        {!!item.Date
                          ? moment(item.Date).format("DD/MM/YYYY")
                          : ""}
                      </td>
                      <td className="p-3  text-center lg:table-cell text-[#39973D]">
                        ₹{!!item.Amount ? item.Amount : 0}
                      </td>
                      <>
                        <td className="p-3 ps-5    text-center lg:table-cell text-gray-600">
                          {!!item.billFormat ? (
